...
from evileye.events_detectors.schedule_alarm_compat import (
    LEGACY_JSON_FOUND,
    LEGACY_JSON_LOST,
    NEW_JSON_FOUND,
    NEW_JSON_LOST,
...
class JsonAdapterScheduleAlarmEvents(DatabaseAdapterBase):
    """Persist schedule alarm events to JSON files and save images."""
    ...
    def set_params_impl(self):
        ...
        self.event_name = "ScheduleAlarmEvent"
        self.table_name = "schedule_alarm_events_json"
    ...
    def _write_event(self, event, is_update: bool):
        ...
        file_name = NEW_JSON_LOST if is_update else NEW_JSON_FOUND
...
# Legacy filenames for readers elsewhere
JSON_FOUND_FILENAMES = (NEW_JSON_FOUND, LEGACY_JSON_FOUND)
JSON_LOST_FILENAMES = (NEW_JSON_LOST, LEGACY_JSON_LOST)
