...
class DatabaseTab(BaseTab):
    ...
    def _setup_database_mode_section(self):
        ...
        self.use_database.setToolTip(
            "Включить/выключить использование базы данных. При выключении данные будут сохраняться в JSON файлы")
        ...
        self.database_mode.setToolTip(
            "Режим работы: PostgreSQL - полная БД, JSON Files - только файлы, Hybrid - БД + файлы")
    ...
    def _edit_project(self):
        ...
        new_name, ok = QInputDialog.getText(self, "Редактировать проект", "Введите новое название:",
