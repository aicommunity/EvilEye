...
class EventsTab(BaseTab):
    ...
    def _setup_attribute_events_tab(self):
        ...
        self.add_validated_widget("Attribute confidence threshold", self.attr_confidence_threshold,
    ...
    def _edit_fov_source(self, row):
        ...
        QMessageBox.information(self, "Редактирование",
                                f"Редактирование источника {source_id} с расписанием: {time_schedule}")
