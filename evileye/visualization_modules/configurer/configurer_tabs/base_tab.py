...
try:
    from PyQt6.QtWidgets import QWidget, QGroupBox, QVBoxLayout, QHBoxLayout, QFormLayout, QPushButton, QLabel, \
        QSizePolicy
    ...
    from PyQt5.QtWidgets import QWidget, QGroupBox, QVBoxLayout, QHBoxLayout, QFormLayout, QPushButton, QLabel, \
        QSizePolicy
