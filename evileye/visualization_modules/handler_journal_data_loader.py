"""
Поток для загрузки данных HandlerJournal в фоновом режиме
"""
...
class HandlerJournalDataLoader(QThread):
    """Поток для загрузки данных HandlerJournal в фоновом режиме"""
    ...
    def __init__(self, db_controller, table_name, params, database_params, table_params,
        ...
        base_name = "evileye.handler_journal_data_loader"
