                ...
                for r, row_data in enumerate(table_rows):
                    ...
                    if found_event and found_path:
                        ...
                        if not found_video_path:
                            self.logger.warning(
                                f"Preview found but video not found: found_preview={found_path}, event_type={found_event.get('event_type', '')}, source={found_event.get('source_name', '')}")
                    if lost_event and lost_path:
                        ...
                        if not lost_video_path:
                            self.logger.warning(
                                f"Preview found but video not found: lost_preview={lost_path}, event_type={lost_event.get('event_type', '')}, source={lost_event.get('source_name', '')}")
