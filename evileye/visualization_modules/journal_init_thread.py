...
class JournalInitThread(QThread):
    ...
    def __init__(self, params, database_params, logger_name: str | None = None,
    ...
    def run(self):
        ...
        try:
            ...
            try:
                self.db_controller = database_controller_pg.DatabaseControllerPg(self.params,
                                                                                 controller_type='Receiver')
