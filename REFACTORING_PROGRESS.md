...
- KPI-gate: `reports/ipc_kpi_gate_20260521_145543/report.md` — **PASS** (`single_video_multiprocess`,
  `poly-videos-gst`).
...
- Этап 3, шаг 3 (убраны прямые global-access зависимости вне API-access модулей):
    ...
    - `evileye/api/core/broker_access.py` и `evileye/api/core/manager_access.py` оставлены как совместимые фасады поверх
      `runtime_services`.
